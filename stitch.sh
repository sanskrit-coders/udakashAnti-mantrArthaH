...
command="pdftk $FILELIST cat X1 Z216-219 Y131 Y132 J289-290 Y132 L307 Y132 A75-81 Y133 D59 D70 output $DESTDIRDIR/udaka_shAnti_1_kalasha_sthApanam.pdf"
$command
#pdftk $FILELIST cat P60 A10-15 P1035 Q879 R399 $DESTDIRDIR/output udaka_shAnti_2_vedAdiH.pdf
# pdftk $FILELIST cat A326-333 B315-325 J351-352 J354-356 C93-99 $DESTDIRDIR/output udakashAntimantrArthaH.pdf
